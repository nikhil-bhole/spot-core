...
import static library.selenium.core.Locator.Loc;
import static library.selenium.core.Locator.getLocator;
...
//        return el.scroll();
     ...
     */
    public Element $(ExpectedCondition<?> exp, Duration... delay) {
     ...
     */
    public Element $(By by, By sub, Duration... delay) {
     ...
     * Returns all element occurrences matching the supplied locator if the elements exist in DOM
     */
    public List<Element> $$(ExpectedCondition<List<WebElement>> exp, Duration... delay) {
     ...
     */
    public List<Element> $$(By by, By sub, Duration... delay) {
        WebDriverWait wait = new WebDriverWait(getDriver(), delay.length > 0 ? delay[0] : getWaitDuration());
     ...
     * Returns first element occurrence matching the supplied locator if an element exists in DOM
     */
    public Element findElement(ExpectedCondition<?> exp, Duration... delay) {
        Element el = new Element(driver, exp, delay);
        return el.scroll();
    }
     ...
     * Finds first nested element within current element matching the supplied locator
     */
    public Element findElement(By by, By sub, Duration... delay) {
        Element el = new Element(driver, ExpectedConditions.presenceOfNestedElementLocatedBy(by, sub), delay);
        return el.scroll();
    }
     ...
     * else empty list
     */
    public List<Element> findElements(By by,Duration...delay) {
        WebDriverWait wait = new WebDriverWait(getDriver(), delay.length > 0 ? delay[0] : getWaitDuration());
        try{
     ...
     */
    public List<Element> findElements(ExpectedCondition<List<WebElement>> exp, Duration... delay) {
        WebDriverWait wait = new WebDriverWait(getDriver(), delay.length > 0 ? delay[0] : getWaitDuration());
        try{
     ...
     * Finds all elements within current element matching the supplied locator
     */
    public List<Element> findElements(By by, By sub, Duration... delay) {
        WebDriverWait wait = new WebDriverWait(getDriver(), delay.length > 0 ? delay[0] : getWaitDuration());
        try{
            List<WebElement> els = wait.until(ExpectedConditions.presenceOfNestedElementsLocatedBy(by, sub));
            List<Element> elements = setElements(els);
    ...
    public Element findClickable(By by, Duration... delay) {
     ...
     */
    public boolean exist(By by, Duration... delay) {
